...
ESPHome configuration for the Shelly 1 Mini Gen3 (ESP32-C3).
...
**Event data:**
- `device`: Device name (e.g., `shelly-1-mini-gen3`)
...
trigger:
  - platform: event
    ...
    event_data:
      device: shelly-1-mini-gen3  # Use your actual device name
      click_type: single
```
